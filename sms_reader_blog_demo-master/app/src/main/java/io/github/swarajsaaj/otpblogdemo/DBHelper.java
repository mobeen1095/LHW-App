...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table timer (id integer primary key AUTOINCREMENT, uc text,name text,number text, sex text,childrenNo  )"
        );
    }
    ...
    public boolean insertContact (String uc, String name, String number, String se, String ch) {
